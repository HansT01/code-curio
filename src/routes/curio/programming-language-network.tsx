    ...
    <main>
      <article class='flex flex-col gap-6 p-8'>
        ...
        <section class='flex flex-col gap-4'>
          <p>
            Programming languages are tools that developers use to communicate instructions to computers. They encompass
            a set of rules and symbols that define the syntax and semantics for writing code.
          </p>
          <p>
        ...
        <section class='flex min-h-120 flex-col gap-6'>
          ...
          >
            <button class='bg-primary hover:bg-secondary text-primary-fg hover:text-secondary-fg flex cursor-pointer items-center gap-2 rounded-lg px-4 py-3'>
              <GithubIcon />
              View Source Code
            </button>
          </a>
        ...
        <section class='flex flex-col gap-4'>
          ...
          <p>
            ...
            proportional to the cube root of the number of respondents who have worked with that language. The
            simulation employs three distinct forces on each node: attraction and repulsion forces between nodes, and a
            radial acceleration to maintain stability.
          </p>
          <p>
            The attraction forces between nodes are based on the edges in the network, which are undirected. The
            strength of the attraction force is determined by the square of the higher overlap between two languages.
            For instance, if 5% of C programmers have worked with Assembly, but 90% of Assembly programmers have worked
            with C, the edge weight is a coefficient multiplied by 0.81. On the other hand, the repulsion force is
            inversely proportional to the squared distance between two nodes.
          </p>
        </section>
        <section class='flex flex-col gap-4'>
          ...
          <p>
            ...
            confirm or challenge the biases and stereotypes about developers of certain languages, as it provides a
            visual representation of the clustering tendencies of languages based on their real-world usage.
          </p>
        </section>
      </article>
    </main>
