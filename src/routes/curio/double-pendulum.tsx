      ...
      <article class='flex flex-col gap-6 p-8'>
        ...
        <section class='flex flex-col gap-4'>
          <p>
            ...
            consists of a single mass swinging from a fixed point, the double pendulum comprises two connected
            pendulums, each with its own mass and length, swinging from a common pivot point. Despite its simple
            structure, the double pendulum's motion can be incredibly complex and unpredictable, making it a subject of
        ...
        <section class='flex flex-col gap-4'>
          ...
          <p>
            In the initial stages of the simulation, the approach was to calculate the angular acceleration at each
            point and directly apply it to update the velocity. While this method produced reasonable results, a
            noticeable discrepancy in the total energy of the system became apparent over time.
          </p>
          <p>
          ...
          <p>
            ...
            would have been possible by simply reducing the step size in the calculation. Additionally, numerical
            analysis allows for more efficient computation of the system's behavior, making it a valuable tool in
            studying complex dynamic systems like the double pendulum.
          </p>
          <p>
            For this simulation, the chosen numerical analysis technique was the Runge-Kutta (RK4) method. Unlike the
            Euler method, which only considers the first derivative in its calculations, RK4 takes into account the
            first four derivatives. This means that RK4 provides a more accurate approximation of the system's behavior
            by accounting for higher-order derivatives.
          </p>
          <p>
